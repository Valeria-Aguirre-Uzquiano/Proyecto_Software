	...
	<article>
		<div class="modal-dialog">	
			...
			<div class="modal-body" style="color: white">	
				...
				<br><br>
		  		<input readonly style="border:2px solid black;" class="des" type="text" placeholder="Descripción..." id="des" name="desi" value="<?php echo $result[3]?>">
		  		</div>					
		...
		if (isset($_POST['modM'])) {
			...
			if ($mat) {
				$mat->ctrInsertMovM($_GET['b'],$_GET['id']);
				?><script type="text/javascript">alert("Cambio guardado");
				window.location.href='inicioBode.php?b=<?php echo $_GET['b'] ?>'</script><?php 
			}else{
